...
export async function doc(providerName) {
    ...
    if (dirName !== 'openapi-to-stackql') {
        console.error(`Must be run from openapi-to-stackql project root...`);
        throw new Error('Must be run from openapi-to-stackql project root');
    }    

    console.log(`documenting ${providerName}...`);

    const providerDir = `providers/src/${providerName}/v00.00.00000`;
